<template>
  <div class="min-h-screen bg-surface flex flex-col">
    ...
    <div class="fixed bottom-0 left-0 right-0 z-50 bg-surface-container-low border-t border-outline-variant/20 px-8 py-4 flex items-center justify-between" style="backdrop-filter: blur(8px)">
